...
const Leader = (props) => {
  return (
    <div class="max-w-max mx-20 my-5 justify-evenly flex flex-row bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
    ...
    <div class="p-5 max-w-full flex flex-row items-center justify-between">
        <a href="#">
            <h5 class="mb-2 text-2xl inline-flex items-center  font-bold tracking-tight text-gray-900 dark:text-white">{props.name}</h5>
        </a>
        <p class="m-3 font-normal text-gray-700 dark:text-gray-400">{props.desci}</p>

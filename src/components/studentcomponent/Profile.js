  ...
  return (
    ...
    <div class="px-6 my-40">
            ...
            <div class="w-full text-center mt-20">
                <div class="flex justify-center lg:pt-4 pt-8 pb-0">
                    <div class="p-3 text-center">
                        <span class="text-xl font-bold block uppercase tracking-wide text-slate-700">184</span>
                        <span class="text-sm text-slate-400">Streaks</span>
                    </div>
                    <div class="p-3 text-center">
        ...
        <div class="text-center mt-2">
            <h3 class="text-2xl text-slate-700 font-bold leading-normal mb-1">Krishna Thompson</h3>
            <div class="text-xs mt-0 mb-2 text-slate-400 font-bold uppercase">
                <i class="fas fa-map-marker-alt mr-2 text-slate-400 opacity-75"></i>Tamilnadu, Madurai
            </div>
        </div>
        <div class="mt-6 py-6 border-t border-slate-200 text-center">
            <div class="flex flex-wrap justify-center">
                <div class="w-full px-4">
                    ...
                    <a href="javascript:;" class="font-normal text-slate-700 hover:text-slate-400"> Edit profile</a>
                </div>
            </div>
        </div>
    </div>
